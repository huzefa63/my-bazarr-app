    ...
    <div className="min-h-screen flex flex-col bg-gradient-to-b from-white to-blue-50 text-gray-800">
      ...
      <section className="px-8 py-16 max-w-5xl mx-auto text-center">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          <Animate onView distance="20px">
            <div className="p-6 h-full bg-white rounded-xl shadow-md text-center hover:shadow-lg transition">
      ...
      <section className="px-8 py-20 bg-gray-50 text-center">
        ...
        <div className="grid md:grid-cols-4 gap-8 max-w-6xl mx-auto">
          <Animate onView distance="20px">
            <div className="flex flex-col h-full items-center bg-white rounded-xl shadow-md p-6 hover:shadow-lg transition">
          ...
          <Animate delay={0.3} onView distance="20px">
            <div className="flex flex-col h-full items-center bg-white rounded-xl shadow-md p-6 hover:shadow-lg transition">
